                        ...
                        if (product.publish != 1)
                          SizedBox(
                            ...
                            child: ElevatedButton(
                              onPressed: () {
                                // Logique pour "Livré"
                                Get.off(() => UpdateProduit(produit: product));
                              },
                              style: AppConstants.outlineButtonStyle.copyWith(
                                side: const MaterialStatePropertyAll(
                                  BorderSide(
                                    color: Color.fromARGB(185, 7, 143, 255),
                                  ),
                                ),
                            ...
                            child: ElevatedButton(
                              ...
                              style: AppConstants.outlineButtonStyle.copyWith(
                                side: MaterialStatePropertyAll(
                                  BorderSide(color: hexToColor('#F7F8FE')),
                                ),
                                backgroundColor: MaterialStatePropertyAll(
                                  hexToColor('#C4C4C4'),
                                ), // Couleur "Livré"
                ...
                child: Column(
                  children: [
                    ...
                    if (otherImages.isNotEmpty)
                      SizedBox(
                        height: 100, // Height for the horizontal list of images
                    ...
                    Divider(color: AppConstants.backgroundColor),
                    Padding(
                              ...
                              product.colors != null && product.colors!.isNotEmpty
                                  ? SizedBox(
                                      ...
                                      child: ListView.builder(
                                        ...
                                        itemBuilder: (context, index) {
                                          final couleur = product.colors![index];
                                          return Padding(
                                            padding: const EdgeInsets.only(right: 8.0),
                                            child: Container(
