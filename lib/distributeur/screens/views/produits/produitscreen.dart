...
import 'package:daymond_collaboration_app/distributeur/screens/newScreens/creationproduit/creation_produit_widget.dart';
import 'package:daymond_collaboration_app/distributeur/screens/views/commande/paginationcommande.dart';
    ...
    return RefreshIndicator(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: const Text('Produits', style: AppConstants.headingTextStyle),
        ),
                          ...
                          child: Container(
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.start,
                                children: [
                                  Image.asset(Images.produits, height: 30),
                    ...
                    child: GridView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        if (product == null ||
                            ...
                            product.price == null) {
                          return emptyMessage(
                            'Pas de produit disponibles',
                          ); // Renvoie un widget vide si product est mal formé
                        }
