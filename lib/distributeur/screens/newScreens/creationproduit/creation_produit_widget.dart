...
import 'package:daymond_collaboration_app/distributeur/controllers/GetUsercontroller.dart';
import 'package:daymond_collaboration_app/distributeur/controllers/parametreController.dart';
import 'package:daymond_collaboration_app/distributeur/controllers/productController.dart';
import 'package:daymond_collaboration_app/distributeur/controllers/shopController.dart';
import 'package:daymond_collaboration_app/distributeur/controllers/walletController.dart';
import 'package:daymond_collaboration_app/distributeur/models/api_response.dart';
import 'package:daymond_collaboration_app/distributeur/models/statemodel.dart';
import 'package:daymond_collaboration_app/distributeur/models/usermodel.dart';
import 'package:daymond_collaboration_app/distributeur/screens/views/produits/produitscreen.dart';
import 'package:daymond_collaboration_app/distributeur/services/userService%20.dart';
...
class _CreationProduitWidgetState extends State<CreationProduitWidget> {
  ...
  List<String> _imagePaths = List.filled(
    8,
    "",
            ...
            child: Column(
              children:
                  _couleursDisponibles.map((couleur) {
                    return ListTile(
                      leading: CircleAvatar(backgroundColor: couleur['color']),
                      title: Text(couleur['name']),
                      onTap: () {
                        setState(() {
                          if (!_couleursAjoutees.any(
                            (c) => c['name'] == couleur['name'],
                          )) {
                                                      ...
                                                      Expanded(
                                                        child: Container(
                                                          ...
                                                          decoration: BoxDecoration(
                                                            ...
                                                            border: Border.all(
                                                              color: Color(0xFFC4C4C4), // même couleur que champ quantité
                                                              width: 1,
                                                            ),
                                                            color: FlutterFlowTheme.of(context).secondaryBackground, // fond harmonisé
                                                          ),
                                                          ...
                                                          child: DropdownButtonHideUnderline(
                                                            child: DropdownButton2<StateParams>(
                                                              ...
                                                              onMenuStateChange: (isOpen) {
                                                                if (!isOpen) _etatController.clear();
                                                              },
                                                            ),
                                                          ),
                                                        ),
