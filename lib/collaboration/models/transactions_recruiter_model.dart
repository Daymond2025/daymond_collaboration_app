...
class TransactionRecruiterModel {
  final int? id;
  ...
  final dynamic transactionRecruiterModelOperator;
  ...
  TransactionRecruiterModel({
    ...
    this.order,
    this.orderProduct,
    this.transactionRecruiterModelOperator,
    this.phoneNumber,
    this.from,
    this.destination,
    this.note,
  ...
  factory TransactionRecruiterModel.fromRawJson(String str) =>
      TransactionRecruiterModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory TransactionRecruiterModel.fromJson(Map<String, dynamic> json) =>
      TransactionRecruiterModel(
        id: json["id"],
        ...
        transactionRecruiterModelOperator: json["operator"],
  ...
  Map<String, dynamic> toJson() => {
        ...
        "operator": transactionRecruiterModelOperator,
...
class Product {
  ...
  factory Product.fromJson(Map<String, dynamic> json) => Product(
        ...
        subCategory: SubCategoryClass.fromJson(json["sub_category"]),
...
class SubCategoryClass {
  ...
  factory SubCategoryClass.fromRawJson(String str) =>
  ...
  factory SubCategoryClass.fromJson(Map<String, dynamic> json) =>
      SubCategoryClass(
        ...
        createdAtFr: json["created_at_fr"],
        updatedAtFr: json["updated_at_fr"],
        category: SubCategoryClass.fromJson(json["category"]),
        picture: json["picture"],
      );
