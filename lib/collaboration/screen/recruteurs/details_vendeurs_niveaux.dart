...
class DetailsVendeurByNiveaux extends StatefulWidget {
  const DetailsVendeurByNiveaux({
    Key? key,
  ...
  @override
  State<DetailsVendeurByNiveaux> createState() =>
      _DetailsVendeurByNiveauxState();
}

class _DetailsVendeurByNiveauxState extends State<DetailsVendeurByNiveaux> {
  ...
  Future getSellerInfo() async {
    ApiResponse responseCommand =
        await seller.CommandesBySeller(widget.sellerStats!.id.toString());
    print("==============Commandes vendeur ==============");
    // print(responseCommand.data);

    if (responseCommand.error == null) {
      setState(() {
        _vendeur = widget.sellerStats!;
  ...
  whatsapp() async {
    var contact = "${_vendeur.user!.phoneNumber}";
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                  image: DecorationImage(
                                      image: _vendeur.user!.picturePath == null
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    "${FormatDateHour('${_vendeur.createdAt}')}",
                                    style: TextStyle(
                        ...
                        child: array_order_users.length == 0
                            ...
                            : ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  print(
                                      array_order_users[index]['order'] == null
                                          ? 'null'
                                          : array_order_users[index]['order']);
            ...
            : Padding(
                ...
                child: Column(
                  children: [
                    ...
                    //       TextSpan(
                    //           text:
                    //               'Il ne vous reste plus que ${int.parse('5') - int.parse('${_vendeur.stars}')} niveaux pour gagner \n un bonus de',
